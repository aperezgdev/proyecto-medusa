  ...
  return (
    <Layout>
      <aside className="flex flex-col w-[100%] h-[100%] gap-[2%] p-12">
        <h1 className="font-[1000] text-3xl h-[5%]">INGRESOS</h1>
        <div className="flex flex-row h-[93%]">
          <div className="flex flex-row w-[100%] h-[100%] gap-[2%] flex-wrap">
            <TablaIngresos />
            <div className="bg-[#FAFAFA] shadow-md h-[40%] w-[20%]"></div>
            <div className="h-min shadow-md w-[15%]">
              <form className="flex flex-col text-lg gap-5 text-white font-semibold">
                <button
                  className="bg-[#C026D3] rounded-md py-3"
                  onClick={async () => {
                    await modalNuevoIngreso()
                  }}
                >
                  Añadir Concepto
                </button>
